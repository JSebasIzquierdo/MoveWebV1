        ...
        {({ values, errors, touched, handleChange, handleBlur }) => (
          <Form>
            <Grid container spacing={2}>
              ...
              <Grid item xs={2}>
                <Typography className={classes.subtitle}>Apellidos:</Typography>
              </Grid>
              <Grid item xs={4}>
                <TextField
                  InputProps={{
              ...
              <Grid item xs={2}>
                <Typography className={classes.subtitle}>Documento:</Typography>
              </Grid>
              <Grid item xs={4}>
                <TextField
                  InputProps={{
              ...
              <Grid item xs={2}>
                <Typography className={classes.subtitle}>Ocupación:</Typography>
              </Grid>
              <Grid item xs={4}>
                <TextField
                  InputProps={{
                  ...
                  {actividades.map((data) => {
                    return (
                      <FormControlLabel
                        ...
                        error={!!(errors.actividades && touched.actividades)}
                        control={
                          <Checkbox
