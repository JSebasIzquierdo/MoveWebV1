...
const Ejercicio = () => {
  ...
  const id = params.id;
  return ejercicios.map((data) => {

    if (data.id_ejercicio == id) {
      return (
        <Container>
          <Formik
            ...
            initialValues={{
              ...
              descripcion: data.descripcion_ejercicio,
              rutaVideo: data.descripcion_ejercicio,
              rutaAudio: data.ruta_audio_ejercicio,
              alternanciaPostura: data.alternancia_ejercicios,
              rutaSensor: data.ruta_puntosensor_ejercicio,
              rupturaAudio: data.tiempo_ruptura_audio_ejercicio,
              rupturaVideo: data.tiempo_ruptura_video_ejercicio,
              nombreVideo: data.nombre_video_ejercicio,
            }}
            onSubmit={(values) => {
                  ...
                  <Grid item xs={6} container spacing={1}>
                    ...
                    <Grid item xs={6}>
                      <TextField
                        ...
                        error={
                          !!(
                            errors.alternanciaPostura &&
                            touched.alternanciaPostura
                          )
                        }
                      ></TextField>
                    </Grid>
